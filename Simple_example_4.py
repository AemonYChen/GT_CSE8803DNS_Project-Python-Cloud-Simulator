# A test simulating the dynamic arrival of VM jobs, including a lot short-lived and high-frequency VMs.
# Example 3 in the progress report.
...
dynamic_arrivals = [
    (0.0, "VM1", Cloudlet("C1", length=40000, cpu_demand_ratio=1.0), 1900),
    (0.0, "VM2", Cloudlet("C2", length=40000, cpu_demand_ratio=1.0), 1900),
    (0.0, "VM3", Cloudlet("C3", length=40000, cpu_demand_ratio=1.0), 1900),
    (0.0, "VM101", Cloudlet("C101", length=40000, cpu_demand_ratio=1.0), 1900),
    (0.0, "VM102", Cloudlet("C102", length=40000, cpu_demand_ratio=1.0), 1900),
    (0.0, "VM103", Cloudlet("C103", length=40000, cpu_demand_ratio=1.0), 1900),
    (0.0, "VM201", Cloudlet("C201", length=40000, cpu_demand_ratio=1.0), 1900),
    (0.0, "VM202", Cloudlet("C202", length=40000, cpu_demand_ratio=1.0), 1900),
    (0.0, "VM203", Cloudlet("C203", length=40000, cpu_demand_ratio=1.0), 1900),
    (0.0, "VM301", Cloudlet("C301", length=2000, cpu_demand_ratio=1.0), 2000),
    (0.0, "VM302", Cloudlet("C302", length=2000, cpu_demand_ratio=1.0), 2000),
    (3.0, "VM311", Cloudlet("C311", length=2000, cpu_demand_ratio=1.0), 2000),
    (3.0, "VM312", Cloudlet("C312", length=2000, cpu_demand_ratio=1.0), 2000),
    (7.0, "VM321", Cloudlet("C321", length=2000, cpu_demand_ratio=1.0), 2000),
    (7.0, "VM322", Cloudlet("C322", length=2000, cpu_demand_ratio=1.0), 2000),
    (9.0, "VM331", Cloudlet("C331", length=2000, cpu_demand_ratio=1.0), 2000),
    (9.0, "VM332", Cloudlet("C332", length=2000, cpu_demand_ratio=1.0), 2000),
    (15.0, "VM341", Cloudlet("C341", length=2000, cpu_demand_ratio=1.0), 2000),
    (15.0, "VM342", Cloudlet("C342", length=2000, cpu_demand_ratio=1.0), 2000),
    (18.0, "VM351", Cloudlet("C351", length=2000, cpu_demand_ratio=1.0), 2000),
    (18.0, "VM352", Cloudlet("C352", length=2000, cpu_demand_ratio=1.0), 2000),
]
